...
router.addRoute('/student/leaderboard', 'LeaderboardView', 'dashboard');
router.addRoute('/student/library', 'DigitalLibrary', 'dashboard');
router.addRoute('/student/badges', 'BadgesPage', 'dashboard');
router.addRoute('/student/community', 'CommunityPage', 'dashboard');
...
router.addRoute('/admin/review-log', 'AdminReviewLog', 'dashboard');
router.addRoute('/admin/overview', 'AdminOverview', 'dashboard');
