...
function renderMobileCalendar(store) {
    ...
    const programTasks = (state.tasks || []).filter(t => t.isActive !== false);
    ...
    return `
        ...
        <div id="cal-modal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.55);backdrop-filter:blur(8px);align-items:center;justify-content:center; padding:16px;">
            <div class="responsive-modal" style="background:var(--bg-surface);border-radius:var(--radius-xl);padding:32px 24px;width:100%;max-width:480px;box-shadow:var(--shadow-lg);direction:rtl;max-height:85vh;overflow-y:auto; transform:translateY(10px); animation:slideUpFade 0.3s forwards;">
        ...
        <div id="cal-detail-modal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.55);backdrop-filter:blur(8px);align-items:center;justify-content:center;">
            <div class="responsive-modal" style="background:var(--bg-surface);border-radius:var(--radius-xl);padding:32px 24px;width:95vw;max-width:440px;box-shadow:var(--shadow-lg);direction:rtl;">
...
export function CalendarView(store) {
    ...
    return `
        ...
        <div id="cal-modal" style="display:none; position:fixed; inset:0; z-index:9999; background:rgba(0,0,0,0.55); backdrop-filter:blur(8px); align-items:center; justify-content:center;">
            <div class="responsive-modal" style="background:var(--bg-surface); border-radius:var(--radius-xl); padding:48px; width:560px; max-width:92vw; box-shadow:var(--shadow-lg); direction:rtl; max-height:90vh; overflow-y:auto;">
        ...
        <!-- DETAIL MODAL -->
        <div id="cal-detail-modal" style="display:none; position:fixed; inset:0; z-index:9999; background:rgba(0,0,0,0.55); backdrop-filter:blur(8px); align-items:center; justify-content:center;">
            <div class="responsive-modal" style="background:var(--bg-surface); border-radius:var(--radius-xl); padding:48px; width:480px; max-width:92vw; box-shadow:var(--shadow-lg); direction:rtl;">
