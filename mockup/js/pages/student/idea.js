...
export function ProgramIdea(store) {
    ...
    return `
        <div style="animation: slideUpFade var(--transition-slow);">
            ...
            <div class="card idea-card responsive-padding-huge responsive-flex" style="border-radius: var(--radius-xl); position: relative; overflow: hidden; display: flex; flex-direction: column; gap: 40px;">
                <!-- Decor gradient bar -->
